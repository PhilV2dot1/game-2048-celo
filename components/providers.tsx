...
export function Providers({ children }: { children: ReactNode }) {
  ...
  if (!isSDKLoaded) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-100 via-gray-50 to-yellow-50/20">
        <div className="text-center">
          <div className="text-celo-yellow text-xl font-semibold mb-2">Loading...</div>
          <div className="text-sm text-gray-600">Initializing 2048</div>
        </div>
      </div>
    );
  }
